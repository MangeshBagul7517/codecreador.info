        ...
        <div>
            <div className='mx-auto max-w-7xl mt-16 px-6 mb-20 relative'>
                ...
                <div className='text-center mb-14'>
                    <h3 className='text-offwhite text-3xl md:text-5xl font-bold mb-3'>Our services</h3>
                    <p className='text-bluish md:text-lg font-normal leading-8'>Tailored Software Solutions to Drive Your Unique Business and Accelerate Strategic Growth</p>
                </div>
